...
module bootrom #(
    ...
    localparam int unsigned StartRomWords = 29;
    localparam logic [31:0] StartRom [StartRomWords] = '{
        // <_start>
        32'h030002B7, // 0x02000000: lui   t0,0x3000
        32'h0202A283, // 0x02000004: lw    t0,32(t0)
        32'h00E2F313, // 0x02000008: andi  t1,t0,14
        32'h00031C63, // 0x0200000C: bnez  t1,0x02000024

        32'h30445073, // 0x02000010: csrwi mie,8
        32'h10500073, // 0x02000014: wfi
        32'h020402B7, // 0x02000018: lui t0,0x2040
        32'h0002A023, // 0x0200001C: sw zero,0(t0) # 2040000 <__global_pointer$+0x3e4d0>
        32'h30405073, // 0x02000020: csrwi mie,0
        32'h00000193, // 0x02000024: li gp,0
        32'h00000213, // 0x02000028: li tp,0
        32'h00000313, // 0x0200002C: li t1,0
        32'h00000393, // 0x02000030: li t2,0
        32'h00000413, // 0x02000034: li s0,0
        32'h00000493, // 0x02000038: li s1,0
        32'h00000513, // 0x0200003C: li a0,0
        32'h00000593, // 0x02000040: li a1,0
        32'h00000613, // 0x02000044: li a2,0
        32'h00000693, // 0x02000048: li a3,0
        32'h00000713, // 0x0200004C: li a4,0
        32'h00000793, // 0x02000050: li a5,0
        32'h00000297, // 0x02000054: auipc t0,0x0
        32'h1AC28293, // 0x02000058: addi t0,t0,428 # 2000200 <_trap_handler_wrapper>
        32'h30529073, // 0x0200005C: csrw mtvec,t0
        32'h030002B7, // 0x02000060: lui t0,0x3000
        32'h0002A283, // 0x02000064: lw t0,0(t0) # 3000000 <__global_pointer$+0xffe4d0>
        32'h00000097, // 0x02000068: auipc ra,0x0
        32'h09808093, // 0x0200006C: addi ra,ra,152 # 2000100 <_eoc>
        32'h00028067 // 0x02000070: jr t0
    };
